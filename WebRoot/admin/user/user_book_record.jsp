...
layui.use('table', function(){
  var table = layui.table;
	table.render({
	  elem: '#test'
	  ,url:'user_book_record?state=1&user_id='+${param.user_id}+'&state=1'
	  ,cols: [[
	    {field:'book_id', width:80, title: '图书ID'}
	    ,{field:'book_name', width:100, title: '图书名'}
	    ,{field:'user_name', width:100, title: '用户名'}
	    ,{field:'create_time', width:150, title: '借阅时间',templet: '#create_time'}
	    ,{field:'update_time', width:150, title: '归还时间',templet: '#update_time'}
	  ]]
